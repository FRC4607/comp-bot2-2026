...
public class GeneralPass extends ParallelCommandGroup {
    /** Creates a new GeneralPass. */
    public GeneralPass(CommandSwerveDrivetrain drivetrain, Indexer indexer, LeftChamber leftChamber, LeftTurret leftTurret, LeftHood leftHood, LeftFlywheel leftFlywheel, RightChamber rightChamber, RightTurret rightTurret, RightHood rightHood, RightFlywheel rightFlywheel) {

        super(
            new PointToPass(drivetrain, leftTurret, leftHood, leftFlywheel, rightTurret, rightHood, rightFlywheel),
